...
**Эпизод 2.** Соло Мии. **Самый быстрый и самый агрессивный трек EP.** Industrial rage — ярость как защитный механизм.

## Сцена

Прошло несколько дней после РАЗРЫВа. Шок прошёл, осталась пустота — и Мия не выдерживает её, не хочет горевать. Она в режиме разрушения: буквально разбирает станцию. Вырывает кабели его рабочего места, разбивает кружку (диегетический звук в intro), стирает архив его сообщений, переписывает код станции на "пустой режим без приёмников". Если он вернётся — ему некуда возвращаться. Она вычищает его следы быстрее, чем плазма гелиохвоста, потому что не может вынести медленное затухание.

Это **не отчаяние и не освобождение** — это активный гнев на собственную беспомощность. В бридже она признаётся себе: "Я не злюсь на тебя / Я злюсь что не могу разозлиться". Она делает это, чтобы хоть что-то делать.

К концу трека станция разобрана, но Мия не легче. Outro — она дышит тяжело, всё горит красным на пульте, и где-то далеко уже думается о том, что разобрать-то можно, а легче не становится. Это подготовка к ТРАНСЛЯЦИИ (Эп.3, NOX в режиме отрицания) — две стороны одного механизма: оба не хотят чувствовать, выбирают разные способы убежать.

**Контрастная функция в EP:** жанровый whiplash после РАЗРЫВа. Слушатель ждёт медляк-сожаление — получает industrial banger. Это первый сигнал, что альбом не будет "6 оттенков грусти".
...
- Альбом до СОРВУ — статус-кво (потеря). Альбом после СОРВУ — рассматривает разные механизмы убежать от этого факта. Каждый трек 3, 4 — попытка/механизм. Только в СЛЕДе механизмы кончаются и принятие приходит.
- Bridge — **семя финального признания**. Она здесь говорит, что разрушает чтобы не сидеть. В СЛЕДе она сидит и принимает. Без СОРВУ принятие в СЛЕДе пустое — нужно сначала пройти через попытку сопротивления.
...
- [ ] **Никаких гроулов, никаких скримов**. Yelled singing — да, screams — нет.
- [ ] Финальный припев заметно плотнее припева 2. Если по интенсивности он равен — пере-генерить, нужно ещё плотнее (это пик трека).
...
**Этот трек — второй эпизод** EP HELIOTAIL. После РАЗРЫВа (Эп.1, дуэт-кульминация), перед ТРАНСЛЯЦИЕЙ (Эп.3, NOX в режиме отрицания).
...
СОРВУ — **самый быстрый, единственный в G minor, единственный без живых распределённых гитар как лидера**. Sonic outlier. Это структурный задумок: каждый средний трек уникален в каком-то одном измерении.
